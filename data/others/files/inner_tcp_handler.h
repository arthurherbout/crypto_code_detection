...
class InnerTcpHandler : public common::libev::IoLoopObserver {
 ...
 private:
  ...
  common::ErrnoError HandleRequestServerTextNotification(Client* client, protocol::request_t* req);

  common::ErrnoError HandleResponceClientActivateDevice(Client* client, protocol::response_t* resp);
  common::ErrnoError HandleResponceClientLogin(Client* client, protocol::response_t* resp);
