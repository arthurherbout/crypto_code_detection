...
vector <string>vec;
int T,N,suma,ats = 0,middle,a=0,index,ats2,saveAts;
char current;
string str;
bool baigta = false;
...
int main()
{
 ...
 //   out << current << " = " <<  suma << endl;
       middle = suma/N;
       if(suma%N > N%2+N/2)middle++;
   // out << "vidurkis - " <<  middle << endl;
    ats2+=abs(suma-middle*N);
       // out <<"ATS2 + "<< abs(suma-middle*N) << endl;
    suma = 0;
