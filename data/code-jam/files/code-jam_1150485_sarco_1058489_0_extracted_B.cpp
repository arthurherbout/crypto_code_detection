...
#define IN_PATH ("C:\\Users\\User\\Documents\\Visual Studio 2008\\Projects\\CodeJam_Round1B_2011\\B-small-attempt1.in")
#define OUT_PATH ("C:\\Users\\User\\Documents\\Visual Studio 2008\\Projects\\CodeJam_Round1B_2011\\B-small-attempt1.out")
...
int main()
{
	...
	for ( long long caseNum = 1; caseNum <= T; ++caseNum )
	{
		...
		double result = ((double) maxDist)/2.0;
